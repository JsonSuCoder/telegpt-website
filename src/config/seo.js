...
export const SEO_CONFIG = {
  // 基本信息
  siteName: 'TelyAI',
  siteUrl: 'https://telyai.org',
  defaultTitle: 'TelyAI - AI Assistant for Telegram | Chat Summary, Grammar Check & Translation',
  ...
  // 图片
  images: {
    ogImage: 'https://telyai.org/images/og-image.jpg',
    twitterCard: 'https://telyai.org/assets/app-main-screen.png',
    logo: 'https://telyai.org/logo.png'
  },
  ...
  pages: {
    home: {
      title: 'TelyAI - AI Assistant for Telegram | Chat Summary, Grammar Check & Translation',
    ...
    features: {
      title: 'TelyAI Features - AI Chat Summary, Grammar Check & Translation',
      description: 'Discover TelyAI\'s powerful AI features: instant chat summaries, grammar checking, real-time translation, meeting scheduling, and contact management.',
      keywords: 'telegram features, ai chat summary, grammar check, translation, meeting scheduler, contact management'
    },
    download: {
      title: 'Download TelyAI - Free AI Assistant for Telegram',
      description: 'Download TelyAI for Windows, macOS, iOS, and Android. Start using AI-powered features in your Telegram chats today. Free to start.',
      keywords: 'download TelyAI, telegram ai app, telegram assistant download, telegram bot download'
    },
    faq: {
      title: 'TelyAI FAQ - Common Questions About Telegram AI Assistant',
      description: 'Find answers to common questions about TelyAI, the AI assistant for Telegram. Learn about features, privacy, pricing, and more.',
      keywords: 'TelyAI faq, telegram ai questions, telegram bot help, TelyAI support'
    }
  },
